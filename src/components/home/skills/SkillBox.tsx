        ...
        <div className=" text-white/70 w-full p-3 h-44 md:h-36 bg-light-sky/10 rounded-lg">
          <div className="w-full items-center flex">
            ...
            <motion.div
              ...
              exit={{ scale: 0 }}
              className="col-span-2 w-11 text-xl text-[#31648c] flex items-center justify-center h-11 rounded-full bg-white/10"
            >
              <FaReact />
            </motion.div>
            <motion.div
            ...
            <motion.div
              ...
              transition={{ duration: 0.2, delay: 1.2 }}
              exit={{ scale: 0 }}
              className="col-span-2 w-11 text-xl text-[#5dae47] flex items-center justify-center h-11 rounded-full bg-white/10"
            >
              {/* <TbBrandRedux /> */}
              <IoLogoNodejs />
            </motion.div>
            ...
            <motion.div
              ...
              exit={{ scale: 0 }}
              className="col-span-2 w-11 text-[#00ed64] text-xl flex items-center justify-center h-11 rounded-full bg-white/10"
            >
              <DiMongodb />
            </motion.div>
          </div>
      ...
      >
        ...
        <Slider {...skillSliderSettings} className="z-30">
          {skillSectionIconsArray.map((curIcon, i) => (
            ...
            >
              <div
                className={`text-center w-full rounded-lg p-2 text-milk/60 ${i % 2 ? "bg-milk/20" : "bg-milk/30"
                  }`}
              >
                {curIcon.title}
              </div>
